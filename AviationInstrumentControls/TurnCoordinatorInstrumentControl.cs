/*****************************************************************************/
/* Project  : AviationInstrumentControls                                  */
...
namespace AviationInstrumentControls
{
    public partial class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorMarks);
