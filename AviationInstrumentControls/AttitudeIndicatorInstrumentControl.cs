...
namespace AviationInstrumentControls
{
    public partial class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
