...
namespace AviationInstrumentControls
{
    public partial class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
