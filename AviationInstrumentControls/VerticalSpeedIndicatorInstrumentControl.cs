...
namespace AviationInstrumentControls
{
    public partial class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.VerticalSpeedNeedle);
