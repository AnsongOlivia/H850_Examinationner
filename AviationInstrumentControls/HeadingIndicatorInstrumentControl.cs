...
namespace AviationInstrumentControls
{
    public partial class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(AviationInstrumentControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);        
