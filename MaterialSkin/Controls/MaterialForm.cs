namespace MaterialSkin.Controls
{
    ...
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        {
            //DEL-S lijinfeng 20220120 FOR 标题栏不绘制三个按钮，避免出现白色横线
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //var hoverBrush = new SolidBrush(Color.FromArgb(100, 0, 255, 0));
            //var downBrush = new SolidBrush(Color.FromArgb(100, 255, 0, 0));
            var g = e.Graphics;
            ...
            if (_formStyle != FormStyles.StatusAndActionBar_None)
            {
                if (ControlBox == true)
                {
                    ...
                    //绘制状态栏
                    g.FillRectangle(new SolidBrush(Color.FromArgb(255, 13, 132, 227)), _statusBarBounds);
                    //绘制活动栏***
                    g.FillRectangle(new SolidBrush(Color.FromArgb(255, 13, 132, 227)), _actionBarBounds);
                }
            ...
            if (DrawerTabControl != null && _formStyle != FormStyles.ActionBar_None && _formStyle != FormStyles.StatusAndActionBar_None)
            {
                ...
                if (_clickAnimManager.IsAnimating())
                {
                    ...
                    var rippleBrush = new SolidBrush(Color.FromArgb((int)(51 - (clickAnimProgress * 50)), Color.Red));
